...
ADMINS = [int(i.strip()) for i in get_config("ADMINS", "6737006051,1053777957,1310392234").split(",") if i.strip()] if get_config("ADMINS", "6737006051,1053777957,1310392234,") else []
...
AUTH_GROUP = [int(i.strip()) for i in get_config("AUTH_GROUP", "-1002223117712,-1002193382366").split(",")] if get_config("AUTH_GROUP", "-1002223117712,-1002193382366") else []
print(AUTH_GROUP)
